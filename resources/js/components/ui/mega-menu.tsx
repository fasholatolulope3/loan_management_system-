            ...
            <AnimatePresence>
              {openMenu === navItem.label && navItem.subMenus && (
                <div className="absolute left-0 top-full w-auto pt-2 z-50">
                  <motion.div
                    className="w-max border border-white/10 bg-[#0A0A0A] p-4 shadow-2xl shadow-black/50"
                    style={{
                      borderRadius: 16,
                    }}
                    layoutId="menu"
                                ...
                                <li key={item.label}>
                                  ...
                                  >
                                    ...
                                    <div className="w-max leading-5">
                                      <p className="shrink-0 text-sm font-medium text-white transition-colors duration-300 group-hover:text-white">
                                        {item.label}
                                      </p>
                                      <p className="shrink-0 text-xs text-white/50 transition-colors duration-300 group-hover:text-white/80">
                                        {item.description}
                                      </p>
                                    </div>
                                  </a>
